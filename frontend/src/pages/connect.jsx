  ...
  return (
    ...
    style={{backgroundImage: `url(${squeeze})`}}>
      ...
      <section className="relative h-[100vh] w-full bg-brand-ivory">
        ...
        <div className="relative z-10 flex items-center justify-center h-full w-full bg-black/20">
      ...
      <section className="h-[40vh] text-center justify-center mb-36 items-center grid grid-rows-3 z-10 relative ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-14 w-[80%] mx-auto pt-20">
          {cards.map((card) => (
            <div
              key={card.id}
              className="p-5 shadow-xl rounded-lg bg-brand-ivory grid-2 text-center hover:scale-105 transition-transform hover:cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col justify-center space-y-5">
            ...
            <p className="text-gray-700 font-semibold text-sm md:text-base w-[90%] md:w-[80%]">
              We’re more than just a platform — we’re your dedicated partner in
      ...
      {/* Key features */}
      <div className="font-semibold text-3xl text-center py-10 bg-brand-ivory">
        Key Features
      </div>
      ...
      <section className="w-full bg-brand-ivory py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto px-6">
          {keyfeatures.map((feature) => (
            <div
              key={feature.id}
              className="flex flex-col space-y-3 bg-white shadow-md rounded-xl p-6 hover:scale-105 transition-transform duration-300 hover:cursor-pointer"
            >
      ...
      <section className="h-[150vh] px-16 relative bg-brand-ivory">
      ...
      <footer className="h-[36vh] bg-brand-navy grid grid-cols-5 gap-10 px-20">
        <div className="grid grid-rows-2 pt-10">
          ...
          <p className="flex gap-2 text-brand-ivory">
            <FaRegCopyright className="" /> 2024 ElitePlan. All rights reserved.{" "}
          </p>
        </div>
